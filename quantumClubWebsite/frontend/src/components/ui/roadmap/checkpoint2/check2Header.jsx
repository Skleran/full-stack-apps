...
const check2Header = () => {
  return (
    <>
      ...
      <div className="mt-4 overflow-hidden rounded-2xl border bg-blue-200 pb-4 shadow-lg dark:bg-blue-950">
        <motion.div
        ...
        >
          <h1 className="text-2xl font-semibold">Welcome to Checkpoint 2!</h1>
          <p className="text-sm">
